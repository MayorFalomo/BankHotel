      ...
      <div className="min-[745px]:w-[80%] max-[745px]:w-[95%] mx-auto">
        <div className="w-full my-[100px] max-[500px]:my-[50px]">
          <div className="flex flex-col items-start gap-[50px]">
            <div className="max-[500px]:hidden flex items-center  gap-[20px] py-2 px-[35px] rounded-[20px] w-fit  border-solid border-[1px] border-gray-400">
              <p className="text-[#FCD043] text-[25px] ">{<TbNorthStar />} </p>
              <p className="text-white font-helvetica">1973 </p>
            </div>

            <div className="max-[800px]:flex-col max-[800px]:flex min-[800px]:flex items-start  gap-[20px] justify-between w-full mt-[40px]">
              ...
              <p className="min-[1100px]:w-[400px] max-[1100px]:w-[300px] max-[800px]:flex max-[800px]:justify-end max-[800px]:items-end max-[800px]:w-[50%] max-[800px]:ml-auto max-[500px]:w-[100%]  font-helvetica leading-8 scroll-m-20 text-[18px] font-normal tracking-tight text-white [&:not(:first-child)]:mt-2">

    ...
    <div className="font-helvetica bg-[#313F38]">
      <div className="flex justify-between items-center gap-[30px] w-[95%] m-auto text-white">
        ...
        <div className="flex flex-col gap-[20px] w-full justify-between">
          <div className="flex items-center justify-between mb-[80px] h-full w-full ">
            <button className="flex items-center justify-around gap-[10px] rounded-[30px] py-2 px-[35px] border-solid border-2 border-gray-400">
            ...
            <div className="cursor-pointer">
              <Image src="/wavy.png" width={50} height={40} alt="img" />
            </div>
          </div>
